    ...
    return (
        <div className="w-screen h-screen">
            ...
            <div className='lg:flex lg:justify-center'>
                <div className='fixed bottom-0 left-0 w-full lg:w-[50%] lg:left-auto h-25 bg-primary rounded-t-2xl flex flex-col p-2 gap-2 items-center justify-around'>
                    ...
                    <div className='w-full flex flex-row gap-4 items-center justify-center'>
                        <input placeholder='Введите требования к тест-кейсу' className='bg-gray-600/50 text-white w-full p-2 rounded-2xl'></input>
